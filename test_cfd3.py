...
components = [
    ...
    ComponentConfig(type="solid_grain", params={"length": 0.5, "d_h": 0.1, "f": 0.0})
]

gas = GasProperties(gamma=1.4, R=287.0)
solver = GeneralSolver1D(gas, nx=300)

print("Running solver with solid_grain...")
res = solver.solve(components, P0_in=500000, T0_in=600, P_amb=0, max_iter=50000)
