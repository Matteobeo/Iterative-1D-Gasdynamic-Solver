...
print("Running solver with solid_grain, mass_flow=0, max_iter=150000, P_amb=101325...")
res = solver.solve(components, P0_in=5000000, T0_in=600, P_amb=101325, max_iter=150000)
